...
contains packages with functions needed in data visualization and exploration: for example, to read excel and csv files, plot data, and filter through data.
...
waste_data_fct <- waste_data %>% 
  mutate(income_cat = factor(x=income_cat,
